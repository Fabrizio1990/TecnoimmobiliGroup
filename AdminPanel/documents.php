...
$act_documents          = true; //setta attiva la voce accesso agenzie
...
<head>
    ...
    <title>TecnoimmobiliGroup  | Gestione documenti</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo(SITE_URL) ?>/AdminPanel/css/documents.css" />
    <!-- modals -->
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#"><i class="fa fa-unlock"></i> Documenti</a></li>
                </ol>
            </section>
    ...
    <script src="<?php echo(SITE_URL) ?>/AdminPanel/js/documents.js"></script>
