...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo(SITE_URL) ?>/AdminPanel/css/agencies_list.css" />
    <!-- modals -->
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#"><i class="fa fa-group"></i> Lista Agenzie</a></li>
                </ol>
            </section>
            ...
            <section class="content">
                ...
                <?php
                include(BASE_PATH."/AdminPanel/include/contents/agencies_list.inc.php");
                ?>
    ...
    <script src="<?php echo(SITE_URL) ?>/AdminPanel/js/agencies_list.js"></script>
