...
function writePropertyCard($pdf,$res,$i,$inPageIdx){
    ...
    $pdf->Image(SITE_URL."/public/images/images_properties/normal/".$res[$i]["img_name"], getColPos($image_pos["x"],$i), getRowPos($image_pos["y"],$inPageIdx), 45,27);
    $pdf->SetFontSize(7);
