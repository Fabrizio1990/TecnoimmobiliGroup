    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="callus">
                    <p>
                        <span><i class="fa fa-envelope"></i> info@tecnoimmobiligroup.it</span>
                    <span><i class="fa fa-phone-square"></i>  N.Verde: <a href="tel:800 97 42 37" style="color:#7af442!important"> 800 97 42 37</a></span>
                    </p>
                </div><!-- end callus-->
            </div><!-- end col-lg-6 -->
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
