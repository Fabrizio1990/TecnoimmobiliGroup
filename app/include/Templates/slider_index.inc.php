<section id="one-parallax" class="parallax" style="background-image: url('<?php echo(SITE_URL) ?>/images/01_parallax.jpg');" data-stellar-background-ratio="0.6" data-stellar-vertical-offset="20">
                            ...
                            <div class="flexslider">
                                <ul class="slides">
                                    <li>
                                        ...
                                        <a href="#"><img src="<?php echo(SITE_URL) ?>/images/sliders/search_slider/02_slider.png" alt=""></a>
                                    </li>
                                    <li>
                                        <div class="desc">
                                            <div class="ps-desc">
                                        ...
                                        <a href="#"><img src="<?php echo(SITE_URL) ?>/images/sliders/search_slider/01_slider.png" alt=""></a>
                                    </li>
                                    <li>
                                        <div class="desc">
                                            <div class="ps-desc">
                                        ...
                                        <a href="#"><img src="<?php echo(SITE_URL) ?>/images/sliders/search_slider/03_slider.png" alt=""></a>
                                    </li>
                                </ul><!-- end slides -->
                            </div><!-- end flexslider -->
